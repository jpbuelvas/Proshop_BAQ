...
export const fetchProducts = async () => {
  try {
    const response = await axios.get(
      'https://script.google.com/macros/s/AKfycbyWD_vG5v7VC_3rOsiL6JvEgr_Y5ZRmOgBRrxAzwdm5eZ2ecVkd3Cq51_LO1Q00yqQp/exec'
    );
...
export const registrarPedido = async (pedidoData) => {
  try {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbyWD_vG5v7VC_3rOsiL6JvEgr_Y5ZRmOgBRrxAzwdm5eZ2ecVkd3Cq51_LO1Q00yqQp/exec', {
