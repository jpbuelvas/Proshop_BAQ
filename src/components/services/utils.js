...
export const fetchProducts = async () => {
  try {
    const response = await axios.get(
      'https://script.google.com/macros/s/AKfycbx5yQXp9XKqnp_JSuZdLHNm1r9OtwHY7g0-yYDu2avyCwFUYF5Aof-9iKCXA8Wj3YVN/exec'
    );
...
export const registrarPedido = async (pedidoData) => {
  try {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbx5yQXp9XKqnp_JSuZdLHNm1r9OtwHY7g0-yYDu2avyCwFUYF5Aof-9iKCXA8Wj3YVN/exec', {
