        ...
        <motion.div initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }}>
          <ul className="flex flex-col gap-4 text-sm lg:text-base text-[#767676]">
            <li
              ...
              className={`border-b-[1px] border-b-[#F0F0F0] pb-2 hover:text-primeColor hover:border-gray-400 duration-300 flex items-center gap-2 ${
                selectedColor === null ? 'text-primeColor font-medium border-gray-400 bg-gray-100' : ''
              }`}
            >
              Todas
            </li>
            {colors.map((item) => (
              <li
                ...
                className={`border-b-[1px] border-b-[#F0F0F0] pb-2 flex items-center gap-2 hover:text-primeColor hover:border-gray-400 duration-300 ${
                  selectedColor === item.title ? 'text-primeColor font-medium border-gray-400 bg-gray-100' : ''
                }`}
              >
                <span
